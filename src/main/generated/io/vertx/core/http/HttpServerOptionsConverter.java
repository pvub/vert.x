 ...
 */
 class HttpServerOptionsConverter {
   ...
   static void fromJson(JsonObject json, HttpServerOptions obj) {
    ...
    if (json.getValue("perFrameWebsocketCompressionSupported") instanceof Boolean) {
      obj.setPerFrameWebsocketCompressionSupported((Boolean)json.getValue("perFrameWebsocketCompressionSupported"));
    }
    if (json.getValue("perMessageWebsocketCompressionSupported") instanceof Boolean) {
      obj.setPerMessageWebsocketCompressionSupported((Boolean)json.getValue("perMessageWebsocketCompressionSupported"));
    }
